...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    super.initState();
    isGoogleSignIn = FirebaseAuth.instance.currentUser?.providerData
  ...
  Future<void> _saveProfile() async {
    ...
    if (uid == null) {
      _showAwesomeSnackbar(
          'Gagal', 'User tidak ditemukan', ContentType.failure);
    ...
    try {
      ...
      _showAwesomeSnackbar(
          'Berhasil', 'Profil berhasil diperbarui', ContentType.success);
      _loadUserData();
    } catch (_) {
      _showAwesomeSnackbar(
          'Gagal', 'Terjadi kesalahan saat menyimpan', ContentType.failure);
    } finally {
      setState(() => _isLoading = false);
    }
  }
